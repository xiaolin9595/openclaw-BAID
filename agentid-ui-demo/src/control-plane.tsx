...
export default function ControlPlane() {
  const authorizationRequestId = new URLSearchParams(window.location.search).get("request_id") ?? undefined;
  ...
  if (!user) return <SignInScreen error={fatalError} onSignedIn={(signedInUser) => void loadWorkspace(authorizationRequestId, signedInUser)} />;
